###########################################################################
## Makefile generated for Simulink model 'tank'. 
## 
## Makefile     : tank.mk
## Generated on : Thu May 24 15:32:05 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/tank_win64.dll
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/admin/PycharmProjects/ZhuangProject/Offline_Agent_v2
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = tank_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = tank_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/tank_win64.dll
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/tank_ert_shrlib_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=tank -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO
...
SRCS = $(START_DIR)/tank_ert_shrlib_rtw/tank.c $(START_DIR)/tank_ert_shrlib_rtw/tank_data.c

MAIN_SRC = $(START_DIR)/tank_ert_shrlib_rtw/ert_main.c
...
%.obj : $(START_DIR)/tank_ert_shrlib_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/tank_ert_shrlib_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
